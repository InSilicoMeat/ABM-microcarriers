...
const REAL A_AGENT_STIFFNESS_CM = 2.20E-04;
const REAL A_AGENT_BOND_S_CM = 0.01;
const REAL A_AGENT_BOND_DESTROY_FACTOR_CM = 1.0;

const REAL A_AGENT_STIFFNESS_CC = 1.00E-04;
const REAL A_AGENT_BOND_S_CC = 0.01;
const REAL A_AGENT_BOND_DESTROY_FACTOR_CC = 1.0;
...
const REAL STRESS_TRESHOLD = 1.00E-08 ;
const REAL STRESS_HILL_EXPONENT = 1 ;
...
const REAL MECH_STRESS_TRESHOLD_DEATH = 1.00E-07 ;
